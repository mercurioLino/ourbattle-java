...
import actions.finds.FindTorneioById;
 ...
 * @author Windows
 */
public class TorneiosOrganizacao extends javax.swing.JFrame implements IAtualizaTabela {
    ...
    public TorneiosOrganizacao(OurBattle ourbattle, Organizacao organizacao) {
    ...
    private void initComponents() {
        ...
        buttonAlterarTorneio.setEnabled(false);
        buttonAlterarTorneio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonAlterarTorneioActionPerformed(evt);
            }
        });
        ...
        buttonRemoverTorneio.setEnabled(false);
        buttonRemoverTorneio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonRemoverTorneioActionPerformed(evt);
            }
        });
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new CreateEditTorneio(this.ourbattle, this.organizacao, null, this);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void buttonAlterarTorneioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAlterarTorneioActionPerformed
        Torneio torneio = FindTorneioById.findTorneioById((String) tabelaTorneios.getValueAt(tabelaTorneios.getSelectedRow(), 0), ourbattle.getTorneios());
        new CreateEditTorneio(this.ourbattle, this.organizacao, torneio, this);
    }//GEN-LAST:event_buttonAlterarTorneioActionPerformed

    private void buttonRemoverTorneioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverTorneioActionPerformed
        Torneio torneio = FindTorneioById.findTorneioById((String) tabelaTorneios.getValueAt(tabelaTorneios.getSelectedRow(), 0), ourbattle.getTorneios());
        if(torneio.getTipo() == "Individual"){
            this.ourbattle.getTorneiosIndividual().remove(torneio);
        } else {
            this.ourbattle.getTorneiosEquipe().remove(torneio);
        }
        this.ourbattle.getTorneios().remove(torneio);
        this.atualizaTabela();
    }//GEN-LAST:event_buttonRemoverTorneioActionPerformed
