...
import actions.FindAtendimentoById;
 ...
 * @author Windows
 */
public class JogadorAtendimento extends javax.swing.JFrame implements IAtualizaTabela{
    ...
    OurBattle ourbattle;
    Jogador jogador;
    public JogadorAtendimento(OurBattle ourbattle, Jogador jogador) {
    ...
    private void initComponents() {
        ...
        bAddAtendimento = new javax.swing.JButton();
        ...
        bAddAtendimento.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        bAddAtendimento.setText("Novo Atendimento");
        bAddAtendimento.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bAddAtendimentoActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(bAddAtendimento, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void bAddAtendimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddAtendimentoActionPerformed
        new CreateJogadorAtendimento(this.ourbattle, this.jogador, this);
    }//GEN-LAST:event_bAddAtendimentoActionPerformed
    ...
    private void tabelaAtendimentosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaAtendimentosMouseClicked
        if(evt.getClickCount() == 2 && this.tabelaAtendimentos.getSelectedRow() != -1){
            Atendimento atendimento = FindAtendimentoById.findAtendimentoById((String) tabelaAtendimentos.getValueAt(tabelaAtendimentos.getSelectedRow(), 0), this.jogador.getAtendimentos());
            new ExibeAtendimento(atendimento);
        }
    }//GEN-LAST:event_tabelaAtendimentosMouseClicked

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bAddAtendimento;
