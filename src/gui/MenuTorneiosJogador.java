 ...
 * @author Windows
 */
public class MenuTorneiosJogador extends javax.swing.JFrame implements IAtualizaTabela{

    OurBattle ourbattle;
    Jogador jogador;
    
    public MenuTorneiosJogador(OurBattle ourbattle, Jogador jogador) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Ranking de Torneios"));
        ...
        tabelaTorneios.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tabelaTorneios);
        tabelaTorneios.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jButton2.setText("Inscrever sua equipe");
