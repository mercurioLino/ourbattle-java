        ...
        this.tabelaTorneios.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if(tabelaTorneios.getSelectedRowCount() > 0){
                    Torneio torneio = FindEquipeById.findEquipeById((String) tabelaTorneios.getValueAt(tabelaTorneios.getSelectedRow(), 0), ourbattle.getTorneios());
                    if (torneio.getO.contains(jogador)) {
